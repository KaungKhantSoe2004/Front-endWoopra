...
<div class=" d-flex py-3" style=" background-color:black">
    ...
    <h5 class=" text-white font-weight-bold text-center  col-11">Campaign</h5>
</div>


<div class=" mt-2 px-3 py-4 " style=" background-color:white">
<img src="{{asset('icons/No need to edit/salary.jpg')}}" style=" width: 100%; height: 100%;" alt="">
</div>
